...
## Status (v0.7.10 — source-available, BUSL-1.1, 2026-06-29)
...
release is `v0.7.10` (Chapter Ballast — per-mission budgets for autonomous
team missions — plus `aivyx init --template` parity with a plain init):
