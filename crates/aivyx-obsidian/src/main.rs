...
use aivyx_obsidian::tools::{ObsidianCreateNote, ObsidianGetNote, ObsidianListFolder, ObsidianSearch, ObsidianUpdateNote};
...
async fn run_ipc_loop() -> ExitCode {
    ...
    let tools: Vec<Arc<dyn Tool>> = vec![Arc::new(ObsidianSearch::new(Arc::clone(&client))), Arc::new(ObsidianGetNote::new(Arc::clone(&client))), Arc::new(ObsidianListFolder::new(Arc::clone(&client))), Arc::new(ObsidianCreateNote::new(Arc::clone(&client))), Arc::new(ObsidianUpdateNote::new(Arc::clone(&client)))];
