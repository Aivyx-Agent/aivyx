...
- Call your fork "Aivyx" or any confusingly similar name
- Use the Aivyx logo or marketing materials without permission
- Distribute your fork through official Aivyx channels (aivyx.ai domains,
  official app store listings, branded installers)
- Claim affiliation with the Aivyx project if there is none

If you fork, please rename. Precedents: Code-OSS vs. VSCode, Chromium vs.
Chrome, Firefox vs. Iceweasel.
