...
## Status (v0.7.16 — source-available, BUSL-1.1, 2026-06-30)
...
release is `v0.7.16` (deterministic auto-delegation for the autonomous
loop, plus `aivyx team status` showing the real halt reason):
