...
## Status (v0.7.3 — source-available, BUSL-1.1, 2026-06-27)
...
release is `v0.7.3` (a fresh agent that works on turn one — starter skills,
semantic memory out of the box, and operator-taught skills):
