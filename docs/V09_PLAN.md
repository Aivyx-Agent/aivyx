...
| 2 | **Freight** | Signed pack bundles, complete: format core (aivyx-pack), the `aivyx-pa pack` CLI, Kitchen worked example live-proven on the rig, operator+publisher docs. `pack update` deferred to the v1.0 web presence. See docs/FREIGHT.md. | ✅ done (53f5e3a) |
