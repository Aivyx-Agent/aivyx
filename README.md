...
release is `v0.7.23` (autonomous-loop hardening from a live dogfood
run — specialist resolution by role, artifact-grounded completion
verification, and malformed-tool-call retry):
