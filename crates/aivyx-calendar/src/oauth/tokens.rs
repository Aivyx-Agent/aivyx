...
//! writes and Tasks 4-7's Calendar API calls read.
//!
...
/// auth-code exchange, what Tasks 4-7 read on each Calendar API
...
impl TokenSet {
    ...
    /// Construct the `Authorization` header value for Calendar API
