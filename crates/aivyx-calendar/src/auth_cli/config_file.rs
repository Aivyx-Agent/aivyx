...
//! # (calendar.readonly + calendar.compose + calendar.send).
...
pub enum ConfigFileError {
    ...
    #[error("config file at {path:?} not found — create it with operator's OAuth client_id + client_secret + redirect_uri (see `aivyx-calendar help`)")]
...
"#,
        ...
        assert_eq!(cfg.scopes.len(), crate::DEFAULT_CALENDAR_SCOPES.len());
