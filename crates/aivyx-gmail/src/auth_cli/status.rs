...
//! - Granted scope (so the operator can confirm `gmail.send`
...
mod tests {
    ...
    fn sample_tokens() -> TokenSet {
        TokenSet {
            ...
            granted_scope: "https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/gmail.send".to_string(),
    ...
    fn format_no_tokens_message_points_at_auth_init() {
        ...
        assert!(out.contains("aivyx-gmail auth init"));
    }
