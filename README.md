...
## Status (v0.7.17 — source-available, BUSL-1.1, 2026-06-30)
...
release is `v0.7.17` (memory listings hide internal `context:pruned`
topics; the loop skips a story after repeated failed auto-delegations):
